...
public class WaterFrameBuffers {
	...
	public int getphotonTexture() {//get the resulting texture
		return refractionTexture;
	}
	
	public int getphotonDepthTexture(){//get the resulting depth texture
	...
	private void initialisephotonFrameBuffer() {
