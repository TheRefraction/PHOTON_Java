...
import photon.texture.TextureData;
...
public class Loader {
	...
	public int loadTexture(String fileName) {
		...
		try {
			...
			if(GLContext.getCapabilities().GL_EXT_texture_filter_anisotropic) {
				...
				LogManager.warning("Anisotropic filtering not supported!");
			}
		} catch (Exception e) {
			e.printStackTrace();
			LogManager.severe("Tried to load texture " + fileName + ".png , didn't work");
			System.exit(-1);
		}
	...
	private TextureData decodeTextureFile(String fileName) {
		...
		try {
			...
			e.printStackTrace();
			LogManager.severe("Tried to load texture " + fileName + ", didn't work");
			System.exit(-1);
		}
