...
public class NormalMappingShader extends ShaderProgram{
	...
	private static final String VERTEX_FILE = "src/photon/shaders/normalMapVShader.txt";
	private static final String FRAGMENT_FILE = "src/photon/shaders/normalMapFShader.txt";
