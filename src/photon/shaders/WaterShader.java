...
public class WaterShader extends ShaderProgram {
	...
	private final static String VERTEX_FILE = "src/photon/shaders/waterVertex.txt";
	private final static String FRAGMENT_FILE = "src/photon/shaders/waterFragment.txt";
